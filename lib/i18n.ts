  ...
  en: {
    translation: {
      ...
      prep: {
        ...
        conversationHint: 'One likely version of the exchange. Read your lines out loud before you go.',
        conversationShowEnglish: 'ENGLISH ON',
        conversationHideEnglish: 'ENGLISH OFF',
        conversationShowEnglishLabel: 'Show English glosses',
        conversationYou: 'YOU',
        conversationThem: 'THEM',
      ...
      journal: {
        ...
        missionJournalTitle: ‘One thought at a time’,
        missionJournalSaved: ‘Saved.’,
        thoughtCount: ‘Thought {{current}} of {{total}}’,
        reflectionPromptLabel: ‘YOUR PROMPT’,
        reflectionPlaceholder1: ‘Take a moment. What did you notice, feel, or do?’,
        reflectionPlaceholderN: ‘Add another thought, if you’d like…’,
        ...
        entrySavedText: ‘Entry saved and “{{title}}” is marked done. Recall quiz: {{score}} of {{total}}.’,
        badgeEarned: ‘BADGE EARNED’,
        backToToday: ‘Back to today’,
        seeProgress: ‘See my progress’,
        recallQuizTitle: ‘A quick recall’,
        recallQuizSubtitle: ‘One word at a time. No score is shown while you answer.’,
  ...
  de: {
    translation: {
      ...
      prep: {
        ...
        conversationHint: 'Eine wahrscheinliche Version des Austauschs. Lies deine Sätze laut vor, bevor du losgehst.',
        conversationShowEnglish: 'ENGLISCH AN',
        conversationHideEnglish: 'ENGLISCH AUS',
        conversationShowEnglishLabel: 'Englische Übersetzungen anzeigen',
        conversationYou: 'DU',
        conversationThem: 'SIE',
      ...
      journal: {
        ...
        missionJournalTitle: 'Ein Gedanke nach dem anderen',
        missionJournalSaved: 'Gespeichert.',
        thoughtCount: 'Gedanke {{current}} von {{total}}',
        reflectionPromptLabel: 'DEINE AUFGABE',
        reflectionPlaceholder1: 'Nimm dir einen Moment. Was hast du bemerkt, gefühlt oder getan?',
        reflectionPlaceholderN: 'Einen weiteren Gedanken hinzufügen, wenn du möchtest …',
        continueToRecall: 'Weiter zur Abfrage',
        nextThought: 'Nächster Gedanke',
        skipThis: 'Diesen überspringen',
        streakDays_one: '{{count}} Tag Folge',
        streakDays_other: '{{count}} Tage Folge',
        entrySavedText: 'Eintrag gespeichert und „{{title}}” ist erledigt. Abfrage: {{score}} von {{total}}.',
        badgeEarned: 'ABZEICHEN VERDIENT',
        backToToday: 'Zurück zu Heute',
        seeProgress: 'Meinen Fortschritt sehen',
        recallQuizTitle: 'Eine kurze Abfrage',
        recallQuizSubtitle: 'Ein Wort nach dem anderen. Während du antwortest, wird die Punktzahl nicht angezeigt.',
