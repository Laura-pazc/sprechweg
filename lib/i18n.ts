    ...
    translation: {
      ...
      missions: {
        ...
        creator: {
          ...
          categoryTitle: 'Create your own',
          mockBadge: 'Local mockup',
          formTitle: 'Build your mission',
          formBody:
            'Name a real situation and preview a complete {{level}} mission before saving it.',
          reviewTitle: 'Review your mission',
          reviewBody: 'Check the local mockup, then edit it or save it to your mission list.',
          scenarioLabel: 'What mission do you want to do?',
          scenarioPlaceholder:
            'For example: Ask about a pottery class near me and sign up for a trial session.',
          ...
          showPreview: 'Preview {{count}} generated words',
          hidePreview: 'Hide word preview',
          edit: 'Edit',
          save: 'Save mission',
          cancel: 'Cancel',
    ...
    translation: {
      ...
      missions: {
        ...
        creator: {
          ...
          categoryTitle: 'Eigene erstellen',
          mockBadge: 'Lokaler Prototyp',
          formTitle: 'Baue deine Mission',
          formBody:
            'Nenne eine echte Situation und prüfe eine komplette {{level}}-Mission vor dem Speichern.',
          reviewTitle: 'Prüfe deine Mission',
          reviewBody: 'Prüfe den lokalen Prototyp und bearbeite oder speichere ihn dann.',
          scenarioLabel: 'Welche Mission möchtest du machen?',
          scenarioPlaceholder:
            'Zum Beispiel: Nach einem Töpferkurs in meiner Nähe fragen und eine Probestunde buchen.',
          ...
          showPreview: '{{count}} erstellte Wörter ansehen',
          hidePreview: 'Wortvorschau schließen',
          edit: 'Bearbeiten',
          save: 'Mission speichern',
          cancel: 'Abbrechen',
