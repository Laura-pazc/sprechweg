    ...
    translation: {
      ...
      missions: {
        ...
        create: {
          ...
          open: 'Create your own mission',
          kicker: 'Mission maker',
          title: 'Create your mission',
          subtitle: 'Name a real-life goal and turn it into German practice.',
          reviewTitle: 'Review your mission',
          reviewSubtitle: 'Check the mock mission before adding it to your list.',
          nameLabel: 'What do you want to do?',
          nameHelp: 'Use a clear real-life goal, such as “Buy a second-hand bicycle.”',
          namePlaceholder: 'Enter a mission name',
          generate: 'Generate mock mission',
          mockNote: 'Prototype mode: this uses local mock content. OpenAI is not connected yet.',
          included: 'What is included',
          includedBody:
            '{{vocab}} vocabulary phrases, a conversation, {{questions}} practice questions, and real-life steps.',
          save: 'Save mission',
          saving: 'Saving…',
  ...
  de: {
    translation: {
      ...
      missions: {
        ...
        create: {
          category: 'Eigene erstellen',
          open: 'Eigene Mission erstellen',
          kicker: 'Missionswerkstatt',
          title: 'Erstelle deine Mission',
          subtitle: 'Verwandle ein echtes Ziel in eine Deutschübung.',
          reviewTitle: 'Prüfe deine Mission',
          reviewSubtitle: 'Sieh dir die Beispielmission an, bevor du sie speicherst.',
          nameLabel: 'Was möchtest du machen?',
          nameHelp:
            'Nutze ein klares Ziel aus dem Alltag, zum Beispiel „Ein gebrauchtes Fahrrad kaufen“.',
          namePlaceholder: 'Name der Mission eingeben',
          generate: 'Beispielmission erstellen',
          mockNote:
            'Prototyp-Modus: Der Inhalt wird lokal erzeugt. OpenAI ist noch nicht verbunden.',
          included: 'Das ist enthalten',
          includedBody:
            '{{vocab}} Vokabelphrasen, ein Gespräch, {{questions}} Übungsfragen und Schritte fürs echte Leben.',
