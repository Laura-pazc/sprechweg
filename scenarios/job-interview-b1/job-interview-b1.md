...
- "Vorstellungsgespräch auf Deutsch — Tipps und Tricks" (German interview tips) — search "Vorstellungsgespräch Deutsch B1 Dialog" on YouTube
- Goethe-Institut B1 business communication: search "Goethe Institut Geschäftskorrespondenz B1"
- Common German interview questions: search "Deutsche Bewerbungsgespräche Fragen und Antworten"
...
4. **Write a sentence** — using "die Stelle," write one sentence about a job position that interests you.

5. **Vocab review** — say all 8 key words/phrases aloud from memory before your interview, in German.

## Level up

At B2, this scenario expands to include: complex conditional questions ("Wenn Sie ein Problem mit einem Kollegen hätten, wie würden Sie damit umgehen?"), past-tense narrative about your career history ("Ich habe... gearbeitet... und dann bin ich..."), and more sophisticated subjunctive mood to discuss hypothetical situations and professional relationships.
