# University Enrollment & Orientation
...
- Hamburg University (Universität Hamburg) official page: search "Universität Hamburg Master Informatik Bewerbung"
- German academic system explanation: search "Deutsches Hochschulsystem Master ECTS Vorlesung Seminar"
- International student guide: search "Internationales Studium Deutschland B2 Deutsch"
...
4. **Write a sentence** — using "der Studiengang," write one sentence about a university degree program that interests you.

5. **Vocab review** — say all 8 key words/phrases aloud from memory in German, particularly the formal academic terms.

## Level up

At C1, this scenario expands to include: complex discussions of academic policies and regulations (Prüfungsordnung, Anerkennung von Leistungen), articulate debate about educational philosophy and research opportunities, sophisticated correspondence with university administration using passive voice and subjunctive mood ("Es würde empfohlen, dass Sie..."), and detailed comprehension of dense academic texts and syllabi (Vorlesungsverzeichnis).
