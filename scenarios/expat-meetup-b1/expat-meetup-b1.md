...
- Internations Hamburg: search "Internations Hamburg Expat Events" for real networking opportunities
- German workplace culture: search "Arbeitskultur Deutschland B1 Deutsch Dialog"
- Expat integration stories: search "Ausländer in Deutschland Erfahrungen B1 Deutsch"
...
4. **Write a sentence** — using "der Grund," write one sentence about why you moved to Hamburg.

5. **Vocab review** — say all 8 key words/phrases aloud from memory before attending a networking event, in German.

## Level up

At B2, this scenario expands to include: deeper professional conversations using subjunctive mood ("Wenn ich nicht hergekommen wäre, hätte ich..."), discussing cultural differences with nuance ("Es ist nicht nur, dass die Menschen direkt sind; es ist auch die Erwartung von Direktheit..."), and articulate networking goals ("Ich suche jemanden mit Expertise in...").
