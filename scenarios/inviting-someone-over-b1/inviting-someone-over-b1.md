# Inviting Someone Over — Hosting at Home
...
- German hospitality and hosting etiquette: search "Gast einladen Deutsch B1 Etikette"
- Typical German dinner conversation: search "Deutsche Gastfreundschaft Essen und Trinken B1"
- Hamburg apartment culture: search "Wohnungskultur Hamburg Deutsch Einladung"
...
4. **Write a sentence** — using "kochen," write one sentence about cooking something special for a friend at home.

5. **Vocab review** — say all 8 key words/phrases aloud from memory before inviting someone over, in German.

## Level up

At B2, this scenario expands to include: hosting a dinner party with multiple guests, managing complex food allergies and dietary restrictions, discussing German hosting customs and expectations ("Bei uns ist es normal, dass..."), entertaining conversation during a meal, and handling unexpected situations (guest arrives late, food burns, etc.) with grace and humor.
