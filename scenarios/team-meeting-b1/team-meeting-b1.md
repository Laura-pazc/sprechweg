# Work Team Meeting — Understanding Discussion

**Target language:** German (learner's source language: English) · **CEFR level:** B1 · **Register:** formal
...
- German business vocabulary: search "Geschäftsdeutsch Meetingvokabel B1" on YouTube
- Asking for clarification politely: search "Verständnisfragen im Beruf Deutsch B1"
- German workplace communication: search "Deutsche Arbeitskommunikation Deutsch Dialog B1"
...
4. **Write a sentence** — using "das Projekt," write one sentence about a work project you're involved in.

5. **Vocab review** — say all 8 key words/phrases aloud from memory, especially the phrases for asking clarification, before your next meeting in German.

## Level up

At B2, this scenario expands to include: complex technical discussions using specialized vocabulary (Architektur, Refactoring, Performance), participating actively in debates with counter-arguments ("Ich würde eher die API überarbeiten, weil..."), understanding humor and cultural workplace norms ("Der deutsche Sinn für Humor ist direkter..."), and taking minutes or presenting findings to the team.
